...
timenow=`date`
echo $timenow
echo "python3 tensorflow_ncs/facenet/ncs_facenet.py --ncsgraph ncs2graphs/tf_graphs/tf_facenethw_graph" 2>&1 | tee -a $logfile
python3 tensorflow_ncs/facenet/ncs_facenet.py --ncsgraph ncs2graphs/tf_graphs/tf_facenethw_graph 2>&1 | tee -a $logfile
